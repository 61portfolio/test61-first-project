...
<footer>
    <div class="left-footer">
         <ul>
      <li><a href="http://www.61designstreet.com/" title="Home 61designstreet" target="_blank"> <svg version="1.1" baseProfile="tiny" id="logo_ds" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
									 x="0px" y="0px" width="88.926px" height="107.551px" viewBox="0 0 88.926 107.551" xml:space="preserve">
       <g>
	...
	<ul>
		...
		?>
			<li class="<?= $classes[$i] ?>"><a href="<?= $menu->link ?>"><?= $menu->name ?></a></li>
		<?php
			$i++;
		}
		?>
		...
		<div class="center-align"> 
			 <span class="<?= $reservation->class_name ?>"><a href="<?= $reservation->link ?>"><?= $reservation->name ?></a></span>
			<div class="footer-logo"> <a href="<?= Yii::$app->homeUrl ?>"><?= Yii::$app->params['settings']['site_title'] ?></a> </div>
		</div>
    </div>
